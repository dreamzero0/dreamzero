...
OUTPUT_DIR=${OUTPUT_DIR:-/data/wangk/checkpoints/dreamzero_g2_mock_action10_video1_2k_v1}
...
echo "G2 mock action-focused shared-DiT LoRA training"
...
echo "Completed G2 mock action-focused shared-DiT LoRA training"
